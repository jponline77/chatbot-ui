...
AS $$
DECLARE
  project_url TEXT := 'https://mhxccqjpcjhsippulsix.supabase.co'
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1oeGNjcWpwY2poc2lwcHVsc2l4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMDAwMDQ2NiwiZXhwIjoyMDI1NTc2NDY2fQ.Gq7jOjXIBiiLbxa3-4jaKNEiScLNwkfMg7xFwD-AQmY'
